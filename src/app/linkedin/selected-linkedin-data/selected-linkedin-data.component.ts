...
@Component({
  selector: 'app-selected-linkedin-data',
  standalone: true,
  imports: [FormsModule, CommonModule],
  templateUrl: './selected-linkedin-data.component.html',
  styleUrl: './selected-linkedin-data.component.css',
})
export class SelectedLinkedinDataComponent implements OnInit {
  linkedinData: any[] = [];
  selectedIds: any[] = [];
  notSelectedIds: any[] = [];
  ...
  private getMail() {
    this.http
      .get(environment.API_BASEURL + '/api/getLinkedinData/getData?selected=true')
      .subscribe((res: any) => {
        console.log(res);
    ...
    this.http
      .post(
        environment.API_BASEURL +
          '/api/getLinkedinData/postLinkedinSelectionData',
        {
